...
public final class CommandFactory { // the final keyword prevents subclassing of this utility class
     ...
     * @param argumentInput command argument to be used during initialisation of the
     *                      command
     * @return Command of the given type initialised for the given argument. If
     *         command creation failed due to an illegal argument, null will be
     *         returned.
    ...
    public static LibraryCommand createCommand(CommandType cmdType, String argumentInput) {
        ...
        try {
            System.err.println(cmdType.name());
            switch (cmdType) {
                /*
                 * TODO Implement individual commands and comment corresponding line back in
                 * once you have a class in place Lastly, get rid of the unsupported Operation
                 * exception.
                 */
