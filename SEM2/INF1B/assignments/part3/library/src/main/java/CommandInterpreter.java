...
/**
 * Class responsible for creating library commands from given user input and
 * executing them.
 */
public class CommandInterpreter {

    /** Delimiter between command keyword and corresponding argument. */
    public static final String COMMAND_ARGUMENT_DELIMITER = " ";
     ...
     * 
     * @param inputLine The input is expected to be a single line starting with a
     *                  command keyword followed by corresponding arguments.
     * @return Command as specified in the given input line. If command creation
     *         failed due to an illegal argument or command keyword, null will be
     *         returned.
    ...
    public LibraryCommand parseCommand(String inputLine) {
        ...
        var split = Utils.splitAtFirstOccurence(inputLine, COMMAND_ARGUMENT_DELIMITER);

        return setupCommand(split[0], split[1]);
    }
     ...
     * @return CommandType associated with given keyword or null if no association
     *         was found.
     */
