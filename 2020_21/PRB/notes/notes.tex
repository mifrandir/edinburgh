...
\begin{definition}
    ...
    integers. The \B{joint probability mass function} of $X,Y$ is
    \begin{align*}
...
\begin{definition}
    The \B{marginal mass functions} of $X,Y$ are defined by
    \begin{align*}
...
\begin{definition}
    Let $X,Y$ be random variables. THen the \B{covariance} of $X$ and $Y$ is defined by
    \begin{align*}
...
\begin{definition}
    Let $X,Y$ be random variables. Then we define the \B{correlation} of
    $X,Y$ to be
    \begin{align*}
