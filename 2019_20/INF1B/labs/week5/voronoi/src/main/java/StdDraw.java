 ...
 * scaledHeight)} <li> {@link #picture(double x, double y, String filename, double scaledWidth,
...
public final class StdDraw
    ...
    public static void arc(double x, double y, double radius, double angle1, double angle2) {
        ...
        if (ws <= 1 && hs <= 1)
            ...
            offscreen.draw(new Arc2D.Double(
                    xs - ws / 2, ys - hs / 2, ws, hs, angle1, angle2 - angle1, Arc2D.OPEN));
        draw();
    }
