...
\begin{theorem}[Notes 4.2]
	...
	\begin{enumerate}
		\item $\alpha f + \beta g$ is integrable on $I$ and \begin{align*}
		      ...
		      \end{align*}
		\item If $f\geq 0$ on $I$ then $\int_I f\:d\lambda \geq 0$; if $f\geq g$ on $I$ then
		      $\int_I f\:d\lambda\geq \int_I g\:d\lambda$.
		\item $\abs f$ is integrable on $I$ and $\abs{\int_I f\:d\lambda}\leq \int_I \abs f\:d\lambda$.
		...
		\item If $f\geq 0$ with $\int_I f\:d\lambda = 0$ then any function $h$ such that $0\leq h<f$ on $I$ is integrable on $I$.
	\end{enumerate}
\end{theorem}

\begin{lemma}[Exercise 4.6]
	Let $f,g:I\to\R$ for some interval $I\subseteq\R$ such that $f=g$ almost everywhere.
	If $f$ is integrable then so is $g$ and
	\begin{align*}
...
\begin{theorem}[Notes 4.8]
	...
	\begin{enumerate}
		...
		\item Suppose that $I$ can be written as the union of disjoint intervals $I_n$ and let $f$
		      be integrable on each of the intervals $I_n$. Then $f$ is integrable on $I$ iff
		      \begin{align*}
...
\begin{theorem}[Notes 4.3]
	...
	\begin{enumerate}
		...
		\item Assume that each $f_n\geq 0$ on $I$ and let $f(x)=\sum_{n=1}^\infty f_n(x)$ for all $x\in I$. Then $f$
		      is integrable on $I$ iff \begin{align*}
...
\begin{lemma}[Fatoux]
	...
	\end{align*}
	If $\liminf_{n\to\infty}\int_I f_n\:d\lambda<\infty$ then $f$ is integrable on $I$ and
	\begin{align*}
...
\begin{definition}
	...
	there exists a sequence of integrable functions $(f_n)$ on $I$ such that
	\begin{align*}
...
\begin{definition}
	A sequence of 1-periodic integrable functions $(k_n)_{n\in\N}$ is called \emph{approximation
...
\begin{theorem}[Notes 5.6]
	Let $(k_n)_{n\in\N}$ a sequence of integrable 1-periodic functions such that
	\begin{enumerate}
