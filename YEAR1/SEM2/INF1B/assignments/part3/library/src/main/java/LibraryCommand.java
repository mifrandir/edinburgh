...
/**
 * Super class for all commands which ties command creation and initialisation
 * using arguments together.
 */
public abstract class LibraryCommand {
	...
	/**
	 * Create the specified command and initialise it with the given command
	 * argument.
	 * 
	...
	/**
	 * Parses the given command arguments and initialised necessary parameters. In
	 * this default version, a blank argument is expected.
	 * 
	 * Subclasses should override this method for more specific argument parsing.
	 * 
